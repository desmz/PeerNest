...
const rawEnvObj = {
  ...
  // auth
  GENERAL_TOKEN_EXPIRES_IN: process.env.GENERAL_TOKEN_EXPIRES_IN,
  ...
  BACKEND_STORAGE_TOKEN_EXPIRE_IN: process.env.BACKEND_STORAGE_TOKEN_EXPIRE_IN,
  BACKEND_STORAGE_URL_EXPIRE_IN: process.env.BACKEND_STORAGE_URL_EXPIRE_IN,
